...
class BaseHandler(webapp2.RequestHandler):
    ...
    def dispatch(self):
        logging.error(self.request.route.handler_method)
        logging.error(self.request.method)
        logging.error(self.request.route_args)
        logging.error(self.request.route_kwargs)
        logging.error(self.request.route.handler)
